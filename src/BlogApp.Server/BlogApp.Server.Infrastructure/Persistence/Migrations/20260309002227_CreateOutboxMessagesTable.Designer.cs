...
namespace BlogApp.Server.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260309002227_CreateOutboxMessagesTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlogApp.Server.Domain.Entities.ConsumerInboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ConsumerName", "OperationId")
                        .IsUnique()
                        .HasDatabaseName("IX_consumer_inbox_consumer_operation")
                        .HasFilter("\"IsDeleted\" = false");

                    b.ToTable("consumer_inbox_messages", (string)null);
                });

            modelBuilder.Entity("BlogApp.Server.Domain.Entities.IdempotencyRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<int?>("AcceptedHttpStatus")
                        .HasColumnType("integer");

                    b.Property<string>("AcceptedResponseJson")
                        .HasColumnType("jsonb");
                    ...
                    b.HasIndex("EndpointName", "OperationId")
                        .IsUnique()
            ...
            modelBuilder.Entity("BlogApp.Server.Domain.Entities.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
